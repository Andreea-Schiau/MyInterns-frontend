...
<!-- 		<input type="text" name="username" placeholder="unique"> <input -->
<!-- 			type="password" name="password" placeholder="unique"> <input -->
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post" action="signUp">
				<span class="login100-form-title p-b-37">
					Username or email are already used. Try another!
				</span>
